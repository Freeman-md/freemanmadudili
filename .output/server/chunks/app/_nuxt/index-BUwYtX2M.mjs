...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-cb604d2e"]]);
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UiLoading = _sfc_main$d;
      const _component_VueMarquee = resolveComponent("VueMarquee");
      const _component_HomeTool = _sfc_main$c;
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiEmpty = _sfc_main$b;
      const _component_HomeJobExperience = _sfc_main$5;
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_HomeJobExperiences = _sfc_main$4;
  const _component_HomeFeaturedProjects = _sfc_main$2;
  const _component_HomeAboutMe = __nuxt_component_4;
...
//# sourceMappingURL=index-BUwYtX2M.mjs.map
