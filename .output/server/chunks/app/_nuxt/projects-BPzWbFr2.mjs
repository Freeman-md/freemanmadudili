import { useSSRContext, computed, toValue, reactive, defineComponent, mergeProps, ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'vue';
import { ssrRenderAttrs, ssrInterpolate } from 'vue/server-renderer';
import { j as fetchDefaults, i as asyncDataDefaults, f as useNuxtApp, c as createError, e as useRuntimeConfig } from '../server.mjs';
...
const useProjects = async (apiUrl) => {
  ...
  const {
    ...
    transform: (projects2) => {
      return projects2.data.map((project) => {
        ...
        return {
          ...project.attributes,
          image: `${runtimeConfig.public.api_url}${(_b = (_a = project.attributes) == null ? void 0 : _a.image) == null ? void 0 : _b.data.attributes.url}`
        };
      });
    }
  }, "$iUX7reuB7S");
...
export { _sfc_main$2 as _, useFetch as a, _sfc_main$1 as b, _sfc_main as c, useAsyncData as d, useProjects as u };
//# sourceMappingURL=projects-BPzWbFr2.mjs.map
