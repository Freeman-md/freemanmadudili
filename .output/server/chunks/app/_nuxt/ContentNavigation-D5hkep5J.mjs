...
import { g as useState, h as useRuntimeConfig, a as __nuxt_component_0 } from '../server.mjs';
import { y as hash } from '../../nitro/node-server.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-BBbKsDJW.mjs';
import { u as useContentPreview } from './preview-D50nKLWp.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-6k0wmMsO.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-D5hkep5J.mjs.map
