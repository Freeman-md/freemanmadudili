...
import { z as withLeadingSlash, j as joinURL, v as withoutTrailingSlash, A as withBase, y as hash } from '../../nitro/node-server.mjs';
import { a as useRequestEvent } from './ssr-CYlKvFbQ.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-6k0wmMsO.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-BBbKsDJW.mjs.map
