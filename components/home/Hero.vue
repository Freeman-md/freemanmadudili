<template>
    <section id="hero" class="container space-y-8">
        <p
            class="text-primary text-lg text-center md:text-left animate-hero"
            style="opacity: 0; transform: translateY(20px)"
        >
            — {{ appConfig.professional_name }} —
        </p>
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 items-center">
            <div
                class="lg:col-span-2 flex flex-col space-y-8 items-start animate-hero"
                style="opacity: 0; transform: translateY(20px)"
            >
                ...
                <div class="text-white" v-html="appConfig.hero_intro"></div>
                <SocialLinks class="inline-block" />
                <a
                    :href="appConfig.resume"
                    target="_blank"
            ...
            <div
                class="order-first md:order-last flex flex-col space-y-4 items-center justify-center animate-hero"
                style="opacity: 0; transform: translateY(20px)"
            >
                <div class="w-1/2 md:w-full md:h-96 overflow-hidden rounded-xl">
                    <NuxtImg
                        ...
                        :alt="appConfig.professional_name"
