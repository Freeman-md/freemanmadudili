...
const experiences: Partial<Experience>[] = [
    {
        ...
        responsibilities: [
            ...
            "Optimized website performance by reducing page UiLoading time by 30%, resulting in a better user experience and increased customer satisfaction."
        ],
        projects: [
            {
                title: "Pay4Me, Inc.",
